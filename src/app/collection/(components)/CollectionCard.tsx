...
import { AnimeCardCover, AnimeCardTitle, AnimeCardMetaInfoWrapper, AnimeCardMetaInfoText, AnimeCardInfoWrapper, AnimeCardDescriptionText } from '@/components/AnimeCard/AnimeCard.styled'
...
const CollectionCard = (
  ...
  <VerticalInfoWrapper gap='8px'>
    ...
    <VerticalInfoWrapper gap='0'>
      <InfoItem label='Create Date' value='20/12/2022' />
      <InfoItem label='Last Update' value='20/05/2023' />
      <InfoItem label='Total' value='5' />
    </VerticalInfoWrapper>
  </VerticalInfoWrapper>
</ListItemCard>)}
