...
const AddCollectionIcon = ({width, height, color}: {width?: string, height?: string, color?: string}) => (
  <svg fill={color || "#000000"} width={width || "64px"} height={height || "64px"} viewBox="-4.74 0 29.588 29.588" id="_17_-_Add_Bookmark">
  ...
  <path id="Path_197" data-name="Path 197" d="M14.6,6.578v5.4a1,1,0,1,0,2,0V6.578a1,1,0,0,0-2,0Z" transform="translate(-5.941 -1)"/>
  <path id="Path_198" data-name="Path 198" d="M18.3,8.28H12.9a1,1,0,0,0,0,2H18.3a1,1,0,0,0,0-2Z" transform="translate(-5.941 -1)"/>
</svg>
)
